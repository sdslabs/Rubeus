...
3. Select 'Specify options for cross-compiling with CMake'. Specify the platform name (i.e. Windows) and specify the C and C++ compilers (`gcc.exe` and `g++.exe` preferably).
